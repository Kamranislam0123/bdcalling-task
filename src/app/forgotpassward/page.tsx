           ...
           <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
             <form action="#" method="POST" className="space-y-6">
               ...
               <div>
                 <button
                   type="submit"
                   className="flex w-full justify-center rounded-md bg-[#FF7D29] px-3 py-1.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus:outline focus:outline-2 "
                 >
                   Submit
                 </button>
               </div>
